...
sed -i s/"'database'        => 'nk_blog'"/"'database'        => '$2'"/ application/database.php
sed -i s/"'username'        => 'root'"/"'username'        => '$2'"/ application/database.php
sed -i s/"'password'        => 'root'"/"'password'        => '$3'"/ application/database.php
